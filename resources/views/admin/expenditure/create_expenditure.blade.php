    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">{{ __('اضافة مصروف يومي') }}</div>

                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.store-expenditure') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="amount_spent_ILS" type="text" class="form-control @error('amount_spent_ILS') is-invalid @enderror" name="amount_spent_ILS" value="{{ old('amount_spent_ILS') }}" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="amount_spent_USD" type="text" class="form-control @error('amount_spent_USD') is-invalid @enderror" name="amount_spent_USD" value="{{ old('amount_spent_USD') }}" autofocus>
