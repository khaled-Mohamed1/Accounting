            ...
            <div class="row">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container">
                        ...
                        <a class="navbar-brand btn btn-secondary text-bg-light" type="button" href="{{route('admin.expenditures.index')}}">المصاريف</a>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <a href="{{route('admin.expenditures.export')}}" class="btn btn-dark"><i class="las la-file-export"></i></a>

                        <form action="{{ route('admin.expenditures.search') }}" method="get" class="d-flex">
                            @csrf
                        ...
                        <form class="d-flex">
                            <a href="{{route('admin.create-expenditure')}}" class="btn btn-success" type="button">اضافة</a>
                        </form>
