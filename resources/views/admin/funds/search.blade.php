            ...
            <div class="row">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container">
                        ...
                        <a class="navbar-brand btn btn-secondary text-bg-light" type="button" href="{{route('admin.funds.index')}}">نتائح البحث عن صندوق المالي</a>
                        &nbsp;
                        &nbsp;
                        &nbsp;
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <form action="{{route('admin.funds.export.search')}}" method="POST">
                            @csrf
