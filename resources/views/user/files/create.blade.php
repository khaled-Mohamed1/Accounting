        ...
        <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="card-header">{{ __('اضافة قسط مالي') }}</div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('user.file.store') }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="outgoing" type="text" class="form-control @error('outgoing') is-invalid @enderror" name="outgoing" value="{{ old('outgoing') }}" required>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="incoming" type="text" class="form-control @error('incoming') is-invalid @enderror" name="incoming" value="{{ old('incoming') }}">
